 ...
 * @param {{moduleName: string, apiUrl: string, version: string, singleFile: boolean, wrap: boolean, tokenPrepend: string|null, modelPrepend: string|null, skipHttpGen: boolean, filter: {whitelist: Array.<string>, blacklist: Array.<string>}}=} options
