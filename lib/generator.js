 ...
 * @param {{moduleName: string, apiUrl: string, version: string, singleFile: boolean, wrap: boolean, tokenPrepend: string, filter: {whitelist: Array.<string>, blacklist: Array.<string>}}=} options
