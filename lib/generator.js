 ...
 * @param {{moduleName: string, apiUrl: string, version: string, singleFile: boolean, wrap: boolean, tokenPrepend: string|null, modelPrepend: string|null, skipHttpGen: boolean=, skipUrlGen: boolean=, addModuleDependency: Array.<string>=, filter: {whitelist: Array.<string>, blacklist: Array.<string>}}=} options
